...
function process_documents() {
  for (var i = 0; i < app.documents.length; i++) {
    ...
    doc.activate()
    process();
    // Export file without prompt
    var dest = doc.fullName;
    exportFileToPSD(doc, dest);
  }
}

// Exports current docuemnt to dest as a PSD file with specified
// options, dest contains the full path including the file name

function exportFileToPSD(doc, dest) {
